...
class CompileHelper final {
 public:
  CompileHelper(Session* session, CompileDesign* compileDesign);
 ...
 private:
  // Caches
  uhdm::IntTypespec* buildIntTypespec(PathId fileId, std::string_view name, const uhdm::Constant* exp, uint32_t line,
