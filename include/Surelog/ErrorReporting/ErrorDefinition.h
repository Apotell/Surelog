...
class ErrorDefinition {
 public:
  ...
  enum ErrorType {
    ...
    PA_INVALID_VOBJECT_LOCATION = 215,
    COMP_COMPILE = 300,
    ...
    INTEGRITY_CHECK_BAD_RELATIVE_LOCATION = 807,
    INTEGRITY_CHECK_COLLECTION_HAS_DUPLICATES = 808,
    INTEGRITY_CHECK_NULL_ACTUAL = 809,
    INTEGRITY_CHECK_NULL_TYPESPEC = 810,
    INTEGRITY_CHECK_UNSUPPORTED_TYPESPEC = 811,
    INTEGRITY_CHECK_INVALID_LOCATION = 812,
    INTEGRITY_CHECK_INVALID_REFPARENT = 813,
    INTEGRITY_CHECK_INVALID_NAME = 814,
    INTEGRITY_CHECK_INVALID_FOREACH_VARIABLE = 815,
    INTEGRITY_CHECK_INVALID_CONST_TPS = 816,
  };
  ...
  class ErrorInfo {
   public:
    ...
    const std::string_view m_errorText;
    const std::string_view m_extraText;
  };
  using ErrorMap = std::map<ErrorType, ErrorInfo, std::less<>>;

  static bool init();

  static const ErrorMap& getErrorInfoMap() { return *mutableGlobalErrorInfoMap(); }
