...
class IncludeFileInfo final {
 public:
  enum class Context : uint16_t { NONE = 0, INCLUDE = 1, MACRO = 2 };
  ...
  IncludeFileInfo(Context context, Action action, PathId sectionFileId,
                  ...
                  uint32_t symbolStartLine, uint32_t symbolStartColumn,
                  uint32_t symbolEndLine, uint32_t symbolEndColumn)
      : IncludeFileInfo(context, action, nullptr, sectionFileId, sectionLine,
                        sectionColumn, sourceLine, sourceColumn, symbolId,
                        symbolStartLine, symbolStartColumn, symbolEndLine,
                        symbolEndColumn, -1) {}
  IncludeFileInfo(Context context, Action action,
      ...
      : m_context(context),
        ...
        m_symbolId(symbolId),
        m_symbolStartLine(symbolStartLine),
        m_symbolEndLine(symbolEndLine),
        m_symbolStartColumn(symbolStartColumn),
        m_symbolEndColumn(symbolEndColumn),
  ...
  SymbolId m_symbolId;
  uint32_t m_symbolStartLine = 0;
  uint32_t m_symbolEndLine = 0;
  uint16_t m_symbolStartColumn = 0;
  uint16_t m_symbolEndColumn = 0;
