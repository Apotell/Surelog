...
class Session;
class SV3_1aPreprocessorTreeListener final : public SV3_1aPpParserBaseListener, public SV3_1aPpTreeListenerHelper {
 public:
  SV3_1aPreprocessorTreeListener(Session* session, PreprocessFile* pp, antlr4::CommonTokenStream* tokens,
  ...
  void exitMacroInstanceNoArgs(SV3_1aPpParser::MacroInstanceNoArgsContext* ctx) final;
  ...
  void exitUndefineall_directive(SV3_1aPpParser::Undefineall_directiveContext* ctx) final;
 ...
 private:
  ...
  void adjustMacroDefinitionLocation(antlr4::tree::ParseTree* tree, NodeId nodeId);
