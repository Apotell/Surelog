...
class Property final : public Variable {
 public:
  Property(DataType* dataType, const FileContent* fc, NodeId varId, NodeId range, std::string_view name, bool is_local,
           bool is_static, bool is_protected, bool is_rand, bool is_randc)
