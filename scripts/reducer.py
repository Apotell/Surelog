...
if is_ci_build() or not is_windows():
  ...
  _default_build_dirpath = Path('out/build/x64-Debug/third_party/UHDM')
  # _default_build_dirpath = Path('out/build/x64-Release/third_party/UHDM')
  # _default_build_dirpath = Path('out/build/x64-Clang-Debug/third_party/UHDM')
  # _default_build_dirpath = Path('out/build/x64-Clang-Release/third_party/UHDM')
...
def _main():
  ...
  if not args.source_dirpath.is_absolute():
    args.source_dirpath = args.workspace_dirpath / args.source_dirpath
