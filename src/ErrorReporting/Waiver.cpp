...
void Waiver::setWaiver(std::string_view messageId, std::string_view fileName, uint32_t line,
...
bool Waiver::macroArgCheck(std::string_view name) { return (m_macroArgCheck.find(name) != m_macroArgCheck.end()); }
