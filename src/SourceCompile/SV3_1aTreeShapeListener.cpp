...
void SV3_1aTreeShapeListener::enterTop_level_rule(SV3_1aParser::Top_level_ruleContext * /*ctx*/) {
  if (m_pf->getFileContent() == nullptr) {
    m_fileContent = new FileContent(m_session, m_pf->getFileId(0), m_pf->getLibrary(), nullptr, BadPathId);
    m_pf->setFileContent(m_fileContent);
    m_pf->getCompileSourceFile()->getCompiler()->getDesign()->addFileContent(m_pf->getFileId(0), m_fileContent);
  } else {
    m_fileContent = m_pf->getFileContent();
  }
  CommandLineParser *clp = m_session->getCommandLineParser();
  if ((!clp->parseOnly()) && (!clp->lowMem())) {
    m_includeFileInfo.emplace(IncludeFileInfo::Context::None, IncludeFileInfo::Action::Push, m_pf->getFileId(0), 0, 0,
                              0, 0, BadSymbolId, 0, 0);
  }
}

void SV3_1aTreeShapeListener::enterTop_level_library_rule(SV3_1aParser::Top_level_library_ruleContext * /*ctx*/) {
  // Visited from Library/SVLibShapeListener.h
  m_fileContent = new FileContent(m_session, m_pf->getFileId(0), m_pf->getLibrary(), nullptr, BadPathId);
  m_pf->setFileContent(m_fileContent);
}

void SV3_1aTreeShapeListener::enterModule_declaration(SV3_1aParser::Module_declarationContext *ctx) {
  std::string ident;
  ...
  addNestedDesignElement(ctx, ident, DesignElement::Module, VObjectType::paModule_keyword);
}

void SV3_1aTreeShapeListener::exitModule_declaration(SV3_1aParser::Module_declarationContext *ctx) {
  if (ctx->ENDMODULE() != nullptr) {
    addVObject((antlr4::ParserRuleContext *)ctx->ENDMODULE(), VObjectType::ENDMODULE);
  }
  addVObject(ctx, VObjectType::paModule_declaration);
  m_nestedElements.pop();
}

void SV3_1aTreeShapeListener::exitModule_keyword(SV3_1aParser::Module_keywordContext *ctx) {
  if (ctx->MODULE() != nullptr) {
    addVObject(ctx, ctx->MODULE()->getText(), VObjectType::paModule_keyword);
  } else if (ctx->MACROMODULE() != nullptr) {
    addVObject(ctx, ctx->MACROMODULE()->getText(), VObjectType::paModule_keyword);
  }
}

void SV3_1aTreeShapeListener::exitClass_constructor_declaration(
    SV3_1aParser::Class_constructor_declarationContext *ctx) {
  if (ctx->ENDFUNCTION()) addVObject((antlr4::ParserRuleContext *)ctx->ENDFUNCTION(), VObjectType::ENDFUNCTION);
...
void SV3_1aTreeShapeListener::exitTask_body_declaration(SV3_1aParser::Task_body_declarationContext *ctx) {
  if (ctx->ENDTASK()) addVObject((antlr4::ParserRuleContext *)ctx->ENDTASK(), VObjectType::ENDTASK);
...
void SV3_1aTreeShapeListener::exitJump_statement(SV3_1aParser::Jump_statementContext *ctx) {
  if (ctx->BREAK()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->CONTINUE(), VObjectType::CONTINUE);
  } else if (ctx->RETURN()) {
...
void SV3_1aTreeShapeListener::exitClass_declaration(SV3_1aParser::Class_declarationContext *ctx) {
  if (ctx->CLASS()) addVObject((antlr4::ParserRuleContext *)ctx->CLASS(), VObjectType::CLASS);
  if (ctx->VIRTUAL()) addVObject((antlr4::ParserRuleContext *)ctx->VIRTUAL(), VObjectType::VIRTUAL);
  if (ctx->IMPLEMENTS()) addVObject((antlr4::ParserRuleContext *)ctx->IMPLEMENTS(), VObjectType::IMPLEMENTS);
  if (ctx->EXTENDS()) addVObject((antlr4::ParserRuleContext *)ctx->EXTENDS(), VObjectType::EXTENDS);
  if (ctx->ENDCLASS()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCLASS(), VObjectType::ENDCLASS);
...
void SV3_1aTreeShapeListener::exitInterface_class_declaration(SV3_1aParser::Interface_class_declarationContext *ctx) {
  if (ctx->INTERFACE()) addVObject((antlr4::ParserRuleContext *)ctx->INTERFACE(), VObjectType::INTERFACE);
  if (ctx->EXTENDS()) addVObject((antlr4::ParserRuleContext *)ctx->EXTENDS(), VObjectType::EXTENDS);
  if (ctx->ENDCLASS()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCLASS(), VObjectType::ENDCLASS);
...
void SV3_1aTreeShapeListener::exitChecker_declaration(SV3_1aParser::Checker_declarationContext *ctx) {
  if (ctx->ENDCHECKER()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCHECKER(), VObjectType::ENDCHECKER);
  addVObject(ctx, VObjectType::paChecker_declaration);
}

void SV3_1aTreeShapeListener::enterSlline(SV3_1aParser::SllineContext * /*ctx*/) {}
...
void SV3_1aTreeShapeListener::exitSlline(SV3_1aParser::SllineContext *ctx) {
  ...
  IncludeFileInfo::Action action =
      static_cast<IncludeFileInfo::Action>(std::stoi(ctx->INTEGRAL_NUMBER()[1]->getText()));
  ...
  if (action == IncludeFileInfo::Action::Push) {
    // Push
    m_includeFileInfo.emplace(IncludeFileInfo::Context::Include, IncludeFileInfo::Action::Push,
                              fileSystem->toPathId(file, symbols), startLine, 0, 0, 0, symbols->registerSymbol(symbol),
...
void SV3_1aTreeShapeListener::enterInterface_declaration(SV3_1aParser::Interface_declarationContext *ctx) {
  std::string ident;
  if (ctx->interface_ansi_header()) {
    ...
    if (ctx->interface_ansi_header()->INTERFACE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->interface_ansi_header()->INTERFACE(), VObjectType::INTERFACE);
    }
    ...
    if (ctx->interface_nonansi_header()->INTERFACE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->interface_nonansi_header()->INTERFACE(), VObjectType::INTERFACE);
    }
  } else {
    ...
    if (ctx->INTERFACE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->INTERFACE(), VObjectType::INTERFACE);
    }
  }
  ident = std::regex_replace(ident, m_regexEscSeqReplace, "");
  addNestedDesignElement(ctx, ident, DesignElement::Interface, VObjectType::INTERFACE);
}

void SV3_1aTreeShapeListener::exitInterface_declaration(SV3_1aParser::Interface_declarationContext *ctx) {
  if (ctx->EXTERN() == nullptr)
    if (ctx->ENDINTERFACE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDINTERFACE(), VObjectType::ENDINTERFACE);
...
void SV3_1aTreeShapeListener::exitProperty_expr(SV3_1aParser::Property_exprContext *ctx) {
  ...
  if (ctx->ENDCASE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ENDCASE(), VObjectType::ENDCASE);
  } else if (ctx->OR()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->OVERLAP_IMPLY(), VObjectType::OVERLAP_IMPLY);
  } else if (ctx->NON_OVERLAP_IMPLY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->NON_OVERLAP_IMPLY(), VObjectType::NON_OVERLAP_IMPLY);
  } else if (ctx->OVERLAPPED()) {
    addVObject((antlr4::ParserRuleContext *)ctx->OVERLAPPED(), VObjectType::OVERLAPPED);
  } else if (ctx->NONOVERLAPPED()) {
    addVObject((antlr4::ParserRuleContext *)ctx->NONOVERLAPPED(), VObjectType::NONOVERLAPPED);
  } else if (ctx->S_NEXTTIME()) {
    addVObject((antlr4::ParserRuleContext *)ctx->S_NEXTTIME(), VObjectType::S_NEXTTIME);
  } else if (ctx->ALWAYS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ALWAYS(), VObjectType::ALWAYS);
  } else if (ctx->S_ALWAYS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->S_ALWAYS(), VObjectType::S_ALWAYS);
  } else if (ctx->S_EVENTUALLY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->S_EVENTUALLY(), VObjectType::S_EVENTUALLY);
  } else if (ctx->EVENTUALLY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->EVENTUALLY(), VObjectType::EVENTUALLY);
  } else if (ctx->UNTIL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->UNTIL(), VObjectType::UNTIL);
  } else if (ctx->S_UNTIL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->S_UNTIL(), VObjectType::S_UNTIL);
  } else if (ctx->IMPLIES()) {
    addVObject((antlr4::ParserRuleContext *)ctx->IMPLIES(), VObjectType::IMPLIES);
  } else if (ctx->IFF()) {
    addVObject((antlr4::ParserRuleContext *)ctx->IFF(), VObjectType::IFF);
  } else if (ctx->ACCEPT_ON()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ACCEPT_ON(), VObjectType::ACCEPT_ON);
  } else if (ctx->REJECT_ON()) {
    addVObject((antlr4::ParserRuleContext *)ctx->REJECT_ON(), VObjectType::REJECT_ON);
  } else if (ctx->SYNC_ACCEPT_ON()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SYNC_ACCEPT_ON(), VObjectType::SYNC_ACCEPT_ON);
  } else if (ctx->SYNC_REJECT_ON()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SYNC_REJECT_ON(), VObjectType::SYNC_REJECT_ON);
  }
...
void SV3_1aTreeShapeListener::exitGenerate_module_case_statement(
  ...
  if (ctx->ENDCASE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCASE(), VObjectType::ENDCASE);
  addVObject(ctx, VObjectType::paGenerate_module_case_statement);
}

void SV3_1aTreeShapeListener::exitIf_generate_construct(SV3_1aParser::If_generate_constructContext *ctx) {
  if (ctx->IF()) addVObject((antlr4::ParserRuleContext *)ctx->IF(), VObjectType::IF);
  if (ctx->ELSE()) addVObject((antlr4::ParserRuleContext *)ctx->ELSE(), VObjectType::ELSE);
...
void SV3_1aTreeShapeListener::exitSequence_declaration(SV3_1aParser::Sequence_declarationContext *ctx) {
  if (ctx->ENDSEQUENCE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDSEQUENCE(), VObjectType::ENDSEQUENCE);
...
void SV3_1aTreeShapeListener::exitSeq_block(SV3_1aParser::Seq_blockContext *ctx) {
  if (ctx->END()) addVObject((antlr4::ParserRuleContext *)ctx->END(), VObjectType::END);
...
void SV3_1aTreeShapeListener::exitGenerate_begin_end_block(SV3_1aParser::Generate_begin_end_blockContext *ctx) {
  if (ctx->END()) addVObject((antlr4::ParserRuleContext *)ctx->END(), VObjectType::END);
...
void SV3_1aTreeShapeListener::exitNamed_port_connection(SV3_1aParser::Named_port_connectionContext *ctx) {
  if (ctx->DOTSTAR()) addVObject((antlr4::ParserRuleContext *)ctx->DOTSTAR(), VObjectType::DOTSTAR);
  if (ctx->OPEN_PARENS()) addVObject((antlr4::ParserRuleContext *)ctx->OPEN_PARENS(), VObjectType::OPEN_PARENS);
  if (ctx->CLOSE_PARENS()) addVObject((antlr4::ParserRuleContext *)ctx->CLOSE_PARENS(), VObjectType::CLOSE_PARENS);
...
void SV3_1aTreeShapeListener::exitPattern(SV3_1aParser::PatternContext *ctx) {
  if (ctx->DOT())
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->DOTSTAR(), VObjectType::DOTSTAR);
  else if (ctx->TAGGED())
...
void SV3_1aTreeShapeListener::exitSpecify_block(SV3_1aParser::Specify_blockContext *ctx) {
  if (ctx->ENDSPECIFY()) addVObject((antlr4::ParserRuleContext *)ctx->ENDSPECIFY(), VObjectType::ENDSPECIFY);
...
void SV3_1aTreeShapeListener::exitConfig_declaration(SV3_1aParser::Config_declarationContext *ctx) {
  if (ctx->ENDCONFIG()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCONFIG(), VObjectType::ENDCONFIG);
...
void SV3_1aTreeShapeListener::exitDpi_import_export(SV3_1aParser::Dpi_import_exportContext *ctx) {
  if (ctx->IMPORT()) addVObject((antlr4::ParserRuleContext *)ctx->IMPORT(), VObjectType::IMPORT);
  if (ctx->EXPORT()) addVObject((antlr4::ParserRuleContext *)ctx->EXPORT(), VObjectType::EXPORT);
...
void SV3_1aTreeShapeListener::exitProperty_declaration(SV3_1aParser::Property_declarationContext *ctx) {
  if (ctx->ENDPROPERTY()) addVObject((antlr4::ParserRuleContext *)ctx->ENDPROPERTY(), VObjectType::ENDPROPERTY);
...
void SV3_1aTreeShapeListener::exitCovergroup_declaration(SV3_1aParser::Covergroup_declarationContext *ctx) {
  if (ctx->ENDGROUP()) addVObject((antlr4::ParserRuleContext *)ctx->ENDGROUP(), VObjectType::ENDGROUP);
...
void SV3_1aTreeShapeListener::exitGenerated_module_instantiation(
  ...
  if (ctx->ENDGENERATE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDGENERATE(), VObjectType::ENDGENERATE);
...
void SV3_1aTreeShapeListener::exitUdp_declaration(SV3_1aParser::Udp_declarationContext *ctx) {
  if (ctx->ENDPRIMITIVE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDPRIMITIVE(), VObjectType::ENDPRIMITIVE);
...
void SV3_1aTreeShapeListener::exitCombinational_body(SV3_1aParser::Combinational_bodyContext *ctx) {
  if (ctx->ENDTABLE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDTABLE(), VObjectType::ENDTABLE);
...
void SV3_1aTreeShapeListener::exitClocking_declaration(SV3_1aParser::Clocking_declarationContext *ctx) {
  if (ctx->DEFAULT()) addVObject((antlr4::ParserRuleContext *)ctx->DEFAULT(), VObjectType::DEFAULT);
  if (ctx->GLOBAL()) addVObject((antlr4::ParserRuleContext *)ctx->GLOBAL(), VObjectType::GLOBAL);
  if (ctx->ENDCLOCKING()) addVObject((antlr4::ParserRuleContext *)ctx->ENDCLOCKING(), VObjectType::ENDCLOCKING);
...
void SV3_1aTreeShapeListener::exitPackage_declaration(SV3_1aParser::Package_declarationContext *ctx) {
  if (ctx->ENDPACKAGE()) addVObject((antlr4::ParserRuleContext *)ctx->ENDPACKAGE(), VObjectType::ENDPACKAGE);
  addVObject(ctx, VObjectType::paPackage_declaration);
}

void SV3_1aTreeShapeListener::enterProgram_declaration(SV3_1aParser::Program_declarationContext *ctx) {
  std::string ident;
  if (ctx->program_ansi_header()) {
    ident = ctx->program_ansi_header()->identifier()->getText();
    if (ctx->program_ansi_header()->PROGRAM()) {
      addVObject((antlr4::ParserRuleContext *)ctx->program_ansi_header()->PROGRAM(), VObjectType::PROGRAM);
    }
    ...
    if (ctx->program_nonansi_header()->PROGRAM()) {
      addVObject((antlr4::ParserRuleContext *)ctx->program_nonansi_header()->PROGRAM(), VObjectType::PROGRAM);
    }
  } else {
    if (ctx->identifier(0))
      ident = ctx->identifier(0)->getText();
    ...
    if (ctx->PROGRAM()) {
      addVObject((antlr4::ParserRuleContext *)ctx->PROGRAM(), VObjectType::PROGRAM);
    }
  }
  ident = std::regex_replace(ident, m_regexEscSeqReplace, "");
...
void SV3_1aTreeShapeListener::enterClass_declaration(SV3_1aParser::Class_declarationContext *ctx) {
  std::string ident;
  if (ctx->identifier(0)) {
    ident = ctx->identifier(0)->getText();
    ident = std::regex_replace(ident, m_regexEscSeqReplace, "");
    ...
    addDesignElement(ctx, "UNNAMED_CLASS", DesignElement::Class, VObjectType::CLASS);
}

SV3_1aTreeShapeListener::SV3_1aTreeShapeListener(Session *session, ParseFile *pf, antlr4::CommonTokenStream *tokens,
                                                 uint32_t lineOffset)
    : SV3_1aTreeShapeHelper(session, pf, tokens, lineOffset) {}

SV3_1aTreeShapeListener::~SV3_1aTreeShapeListener() = default;

void SV3_1aTreeShapeListener::enterPackage_declaration(SV3_1aParser::Package_declarationContext *ctx) {
  if (ctx->PACKAGE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->PACKAGE(), VObjectType::PACKAGE);
  }
...
void SV3_1aTreeShapeListener::enterTimeUnitsDecl_TimeUnit(SV3_1aParser::TimeUnitsDecl_TimeUnitContext *ctx) {
  if (m_currentElement) {
...
void SV3_1aTreeShapeListener::enterTimescale_directive(SV3_1aParser::Timescale_directiveContext *ctx) {
  ...
  if (std::regex_match(value, base_match, base_regex)) {
    ...
    if ((compUnitTimeInfo.m_timeUnitValue != 1) && (compUnitTimeInfo.m_timeUnitValue != 10) &&
    ...
    if ((compUnitTimeInfo.m_timePrecisionValue != 1) && (compUnitTimeInfo.m_timePrecisionValue != 10) &&
    ...
    uint64_t precisionInFs =
        TimeInfo::femtoSeconds(compUnitTimeInfo.m_timePrecision, compUnitTimeInfo.m_timePrecisionValue);
...
void SV3_1aTreeShapeListener::enterTimeUnitsDecl_TimePrecision(SV3_1aParser::TimeUnitsDecl_TimePrecisionContext *ctx) {
  if (m_currentElement) {
    m_currentElement->m_timeInfo.m_type = TimeInfo::Type::TimeUnitTimePrecision;
    auto pair = getTimeValue(ctx->time_literal());
...
void SV3_1aTreeShapeListener::exitTime_literal(SV3_1aParser::Time_literalContext *ctx) {
  auto pair = getTimeValue(ctx);
  uint64_t value = pair.first;
  if (ctx->INTEGRAL_NUMBER())
    addVObject((antlr4::ParserRuleContext *)ctx->INTEGRAL_NUMBER(), std::to_string(value), VObjectType::INT_CONST);
  else if (ctx->REAL_NUMBER())
    addVObject((antlr4::ParserRuleContext *)ctx->REAL_NUMBER(), std::to_string(value), VObjectType::INT_CONST);
  const std::string &s = ctx->time_unit()->getText();
  if ((s == "s") || (s == "ms") || (s == "us") || (s == "ns") || (s == "ps") || (s == "fs")) {
  } else {
...
void SV3_1aTreeShapeListener::exitTime_unit(SV3_1aParser::Time_unitContext *ctx) {
  const std::string &s = ctx->getText();
  if ((s == "s") || (s == "ms") || (s == "us") || (s == "ns") || (s == "ps") || (s == "fs")) {
    addVObject(ctx, ctx->getText(), VObjectType::paTime_unit);
  } else {
    addVObject((antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER(), ctx->getText(), VObjectType::STRING_CONST);
...
void SV3_1aTreeShapeListener::enterTimeUnitsDecl_TimeUnitDiv(SV3_1aParser::TimeUnitsDecl_TimeUnitDivContext *ctx) {
  if (m_currentElement) {
    m_currentElement->m_timeInfo.m_type = TimeInfo::Type::TimeUnitTimePrecision;
    auto pair = getTimeValue(ctx->time_literal(0));
    m_currentElement->m_timeInfo.m_timeUnitValue = pair.first;
...
void SV3_1aTreeShapeListener::enterUdp_declaration(SV3_1aParser::Udp_declarationContext *ctx) {
  std::string ident;
  if (ctx->udp_ansi_declaration()) {
    ident = ctx->udp_ansi_declaration()->identifier()->getText();
    if (ctx->udp_ansi_declaration()->PRIMITIVE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->udp_ansi_declaration()->PRIMITIVE(), VObjectType::PRIMITIVE);
    }
    ...
    if (ctx->udp_nonansi_declaration()->PRIMITIVE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->udp_nonansi_declaration()->PRIMITIVE(), VObjectType::PRIMITIVE);
    }
  } else {
    if (ctx->identifier(0)) {
      ident = ctx->identifier(0)->getText();
    ...
    if (ctx->PRIMITIVE()) {
      addVObject((antlr4::ParserRuleContext *)ctx->PRIMITIVE(), VObjectType::PRIMITIVE);
    }
  }
  ident = std::regex_replace(ident, m_regexEscSeqReplace, "");
  addDesignElement(ctx, ident, DesignElement::Primitive, VObjectType::PRIMITIVE);
}

void SV3_1aTreeShapeListener::enterSurelog_macro_not_defined(SV3_1aParser::Surelog_macro_not_definedContext *ctx) {
...
void SV3_1aTreeShapeListener::exitInitVal_Integral(SV3_1aParser::InitVal_IntegralContext *ctx) {
  auto number = ctx->INTEGRAL_NUMBER();
  addVObject(ctx, number->getText(),
             VObjectType::INT_CONST);  // TODO: Octal, Hexa...
}

void SV3_1aTreeShapeListener::exitScalar_Integral(SV3_1aParser::Scalar_IntegralContext *ctx) {
  auto number = ctx->INTEGRAL_NUMBER();
  addVObject(ctx, number->getText(),
             VObjectType::INT_CONST);  // TODO: Octal, Hexa...
}

void SV3_1aTreeShapeListener::exitUnbased_unsized_literal(SV3_1aParser::Unbased_unsized_literalContext *ctx) {
...
void SV3_1aTreeShapeListener::exitPound_delay_value(SV3_1aParser::Pound_delay_valueContext *ctx) {
  if (ctx->POUND_DELAY()) {
    addVObject(ctx, ctx->POUND_DELAY()->getText(), VObjectType::INT_CONST);
  } else if (ctx->POUND_POUND_DELAY()) {
    addVObject(ctx, ctx->POUND_POUND_DELAY()->getText(), VObjectType::POUND_POUND_DELAY);
...
void SV3_1aTreeShapeListener::exitData_type(SV3_1aParser::Data_typeContext *ctx) {
  if (ctx->VIRTUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->VIRTUAL(), VObjectType::VIRTUAL);
  }

  std::string text;
  if ((ctx->class_scope() != nullptr) || (ctx->package_scope() != nullptr) || (ctx->string_type() != nullptr)) {
    text = ctx->getText();
  } else {
  ...
  if (text.empty()) {
    ...
    if (npos != std::string_view::npos) stext.remove_suffix(stext.length() - npos);
...
void SV3_1aTreeShapeListener::exitInterface_identifier(SV3_1aParser::Interface_identifierContext *ctx) {
...
void SV3_1aTreeShapeListener::exitData_type_or_void(SV3_1aParser::Data_type_or_voidContext *ctx) {
  if (ctx->VOID()) {
...
void SV3_1aTreeShapeListener::exitString_value(SV3_1aParser::String_valueContext *ctx) {
  std::string ident;
...
void SV3_1aTreeShapeListener::exitIdentifier(SV3_1aParser::IdentifierContext *ctx) {
  std::string ident;
...
void SV3_1aTreeShapeListener::exitUnique_priority(SV3_1aParser::Unique_priorityContext *ctx) {
  if (ctx->PRIORITY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->PRIORITY(), VObjectType::PRIORITY);
  } else if (ctx->UNIQUE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->UNIQUE(), VObjectType::UNIQUE);
  } else if (ctx->UNIQUE0()) {
    addVObject((antlr4::ParserRuleContext *)ctx->UNIQUE0(), VObjectType::UNIQUE0);
  }
...
void SV3_1aTreeShapeListener::exitPart_select_op_colon(SV3_1aParser::Part_select_op_colonContext *ctx) {
...
void SV3_1aTreeShapeListener::exitSystem_task_names(SV3_1aParser::System_task_namesContext *ctx) {
  ...
  if (ctx->TIME())
    addVObject((antlr4::ParserRuleContext *)ctx->TIME(), ident, VObjectType::STRING_CONST);
  else if (ctx->REALTIME())
    addVObject((antlr4::ParserRuleContext *)ctx->REALTIME(), ident, VObjectType::STRING_CONST);
  else if (ctx->ASSERT())
    addVObject((antlr4::ParserRuleContext *)ctx->ASSERT(), ident, VObjectType::STRING_CONST);
  else if (!ctx->SIMPLE_IDENTIFIER().empty())
    addVObject((antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER()[0], ident, VObjectType::STRING_CONST);
  else if (ctx->SIGNED())
    addVObject((antlr4::ParserRuleContext *)ctx->SIGNED(), ident, VObjectType::STRING_CONST);
  else if (ctx->UNSIGNED())
    addVObject((antlr4::ParserRuleContext *)ctx->UNSIGNED(), ident, VObjectType::STRING_CONST);
  addVObject(ctx, VObjectType::paSystem_task_names);
}

void SV3_1aTreeShapeListener::exitClass_type(SV3_1aParser::Class_typeContext *ctx) {
  std::string ident;
...
void SV3_1aTreeShapeListener::exitHierarchical_identifier(SV3_1aParser::Hierarchical_identifierContext *ctx) {
  std::string ident;
  ...
  for (auto &o : ctx->children) {
    ...
    if (tnode != nullptr) {
      ...
      if (symbol->getType() == SV3_1aParser::SIMPLE_IDENTIFIER ||
        ...
        ident = tnode->getText();
        ident = std::regex_replace(ident, m_regexEscSeqReplace, "");
        addVObject((antlr4::ParserRuleContext *)tnode, ident, VObjectType::STRING_CONST);
      } else if (symbol->getType() == SV3_1aParser::THIS || symbol->getType() == SV3_1aParser::RANDOMIZE ||
...
void SV3_1aTreeShapeListener::exitFile_path_spec(SV3_1aParser::File_path_specContext *ctx) {
  std::string ident;
  ident = ctx->getText();
...
void SV3_1aTreeShapeListener::exitAnonymous_program(SV3_1aParser::Anonymous_programContext *ctx) {
  if (ctx->ENDPROGRAM()) addVObject((antlr4::ParserRuleContext *)ctx->ENDPROGRAM(), VObjectType::ENDPROGRAM);
...
void SV3_1aTreeShapeListener::exitProcedural_continuous_assignment(
  ...
  if (ctx->ASSIGN()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->DEASSIGN(), VObjectType::DEASSIGN);
  } else if (ctx->FORCE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->FORCE(), VObjectType::FORCE);
  } else if (ctx->RELEASE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->RELEASE(), VObjectType::RELEASE);
  }
...
void SV3_1aTreeShapeListener::exitDrive_strength(SV3_1aParser::Drive_strengthContext *ctx) {
  if (ctx->SUPPLY0()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SUPPLY0(), VObjectType::SUPPLY0);
  } else if (ctx->STRONG0()) {
    addVObject((antlr4::ParserRuleContext *)ctx->STRONG0(), VObjectType::STRONG0);
  } else if (ctx->PULL0()) {
  ...
  if (ctx->SUPPLY1()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SUPPLY1(), VObjectType::SUPPLY1);
  } else if (ctx->STRONG1()) {
    addVObject((antlr4::ParserRuleContext *)ctx->STRONG1(), VObjectType::STRONG1);
  } else if (ctx->PULL1()) {
...
void SV3_1aTreeShapeListener::exitEvent_trigger(SV3_1aParser::Event_triggerContext *ctx) {
  if (ctx->IMPLY()) addVObject((antlr4::ParserRuleContext *)ctx->IMPLY(), VObjectType::paBinOp_Imply);
  if (ctx->NON_BLOCKING_TRIGGER_EVENT_OP())
    addVObject((antlr4::ParserRuleContext *)ctx->NON_BLOCKING_TRIGGER_EVENT_OP(),
...
void SV3_1aTreeShapeListener::exitStream_operator(SV3_1aParser::Stream_operatorContext *ctx) {
  if (ctx->SHIFT_RIGHT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SHIFT_RIGHT(), VObjectType::paBinOp_ShiftRight);
  } else if (ctx->SHIFT_LEFT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SHIFT_LEFT(), VObjectType::paBinOp_ShiftLeft);
  }
...
void SV3_1aTreeShapeListener::exitLoop_statement(SV3_1aParser::Loop_statementContext *ctx) {
  if (ctx->DO()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->FOREVER(), VObjectType::FOREVER);
  } else if (ctx->REPEAT()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->FOREACH(), VObjectType::FOREACH);
  }
  addVObject(ctx, VObjectType::paLoop_statement);
}

void SV3_1aTreeShapeListener::exitPackage_scope(SV3_1aParser::Package_scopeContext *ctx) {
  std::string ident;
  antlr4::ParserRuleContext *childCtx = nullptr;
  if (ctx->SIMPLE_IDENTIFIER()) {
    childCtx = (antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER();
...
void SV3_1aTreeShapeListener::exitPs_identifier(SV3_1aParser::Ps_identifierContext *ctx) {
  std::string ident;
  antlr4::ParserRuleContext *childCtx = nullptr;
...
void SV3_1aTreeShapeListener::exitExpression(SV3_1aParser::ExpressionContext *ctx) {
  if (ctx->MATCHES()) {
    addVObject((antlr4::ParserRuleContext *)ctx->MATCHES(), VObjectType::paMatches);
  }
  if (ctx->PLUS()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->PLUS(), VObjectType::paUnary_Plus);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->PLUS(), VObjectType::paBinOp_Plus);
  } else if (ctx->MINUS()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->MINUS(), VObjectType::paUnary_Minus);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->MINUS(), VObjectType::paBinOp_Minus);
  } else if (ctx->BANG()) {
    addVObject((antlr4::ParserRuleContext *)ctx->BANG(), VObjectType::paUnary_Not);
  } else if (ctx->TILDA()) {
    addVObject((antlr4::ParserRuleContext *)ctx->TILDA(), VObjectType::paUnary_Tilda);
  } else if (ctx->BITW_AND()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_AND(), VObjectType::paUnary_BitwAnd);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_AND(), VObjectType::paBinOp_BitwAnd);
  } else if (ctx->BITW_OR()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_OR(), VObjectType::paUnary_BitwOr);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_OR(), VObjectType::paBinOp_BitwOr);
  } else if (ctx->BITW_XOR()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_XOR(), VObjectType::paUnary_BitwXor);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_XOR(), VObjectType::paBinOp_BitwXor);
  } else if (ctx->REDUCTION_NAND()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_NAND(), VObjectType::paUnary_ReductNand);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_NAND(), VObjectType::paBinOp_ReductNand);
  } else if (ctx->REDUCTION_NOR()) {
    addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_NOR(), VObjectType::paUnary_ReductNor);
  } else if (ctx->REDUCTION_XNOR1()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_XNOR1(), VObjectType::paUnary_ReductXnor1);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_XNOR1(), VObjectType::paBinOp_ReductXnor1);
  } else if (ctx->REDUCTION_XNOR2()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_XNOR2(), VObjectType::paUnary_ReductXnor2);
    else
      addVObject((antlr4::ParserRuleContext *)ctx->REDUCTION_XNOR2(), VObjectType::paBinOp_ReductXnor2);
  } else if (ctx->STARSTAR()) {
    addVObject((antlr4::ParserRuleContext *)ctx->STARSTAR(), VObjectType::paBinOp_MultMult);
  } else if (ctx->STAR()) {
    addVObject((antlr4::ParserRuleContext *)ctx->STAR(), VObjectType::paBinOp_Mult);
  } else if (ctx->DIV()) {
    addVObject((antlr4::ParserRuleContext *)ctx->DIV(), VObjectType::paBinOp_Div);
  } else if (ctx->PERCENT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->PERCENT(), VObjectType::paBinOp_Percent);
  } else if (ctx->SHIFT_RIGHT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SHIFT_RIGHT(), VObjectType::paBinOp_ShiftRight);
  } else if (ctx->SHIFT_LEFT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SHIFT_LEFT(), VObjectType::paBinOp_ShiftLeft);
  } else if (ctx->ARITH_SHIFT_RIGHT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ARITH_SHIFT_RIGHT(), VObjectType::paBinOp_ArithShiftRight);
  } else if (ctx->ARITH_SHIFT_LEFT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ARITH_SHIFT_LEFT(), VObjectType::paBinOp_ArithShiftLeft);
  } else if (ctx->LESS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->LESS(), VObjectType::paBinOp_Less);
  } else if (ctx->LESS_EQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->LESS_EQUAL(), VObjectType::paBinOp_LessEqual);
  } else if (ctx->PLUSPLUS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->PLUSPLUS(), VObjectType::paIncDec_PlusPlus);
  } else if (ctx->MINUSMINUS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->MINUSMINUS(), VObjectType::paIncDec_MinusMinus);
  } else if (ctx->GREATER()) {
    addVObject((antlr4::ParserRuleContext *)ctx->GREATER(), VObjectType::paBinOp_Great);
  } else if (ctx->GREATER_EQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->GREATER_EQUAL(), VObjectType::paBinOp_GreatEqual);
  } else if (ctx->INSIDE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->INSIDE(), VObjectType::INSIDE);
  } else if (ctx->EQUIV()) {
    addVObject((antlr4::ParserRuleContext *)ctx->EQUIV(), VObjectType::paBinOp_Equiv);
  } else if (ctx->NOTEQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->NOTEQUAL(), VObjectType::paBinOp_Not);
  } else if (ctx->BINARY_WILDCARD_EQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->BINARY_WILDCARD_EQUAL(), VObjectType::paBinOp_WildcardEqual);
  } else if (ctx->BINARY_WILDCARD_NOTEQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->BINARY_WILDCARD_NOTEQUAL(), VObjectType::paBinOp_WildcardNotEqual);
  } else if (ctx->FOUR_STATE_LOGIC_EQUAL()) {
    addVObject((antlr4::ParserRuleContext *)ctx->FOUR_STATE_LOGIC_EQUAL(), VObjectType::paBinOp_FourStateLogicEqual);
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->WILD_EQUAL_OP(), VObjectType::paBinOp_WildEqual);
  } else if (ctx->WILD_NOTEQUAL_OP()) {
    addVObject((antlr4::ParserRuleContext *)ctx->WILD_NOTEQUAL_OP(), VObjectType::paBinOp_WildEqual);
  } else if (ctx->BITW_AND()) {
    if (ctx->expression().size() == 1)
      addVObject((antlr4::ParserRuleContext *)ctx->BITW_AND(), VObjectType::paUnary_BitwAnd);
    else
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->LOGICAL_AND()[0], VObjectType::paBinOp_LogicAnd);
  } else if (ctx->LOGICAL_OR()) {
    addVObject((antlr4::ParserRuleContext *)ctx->LOGICAL_OR(), VObjectType::paBinOp_LogicOr);
  } else if (ctx->IMPLY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->IMPLY(), VObjectType::paBinOp_Imply);
  } else if (ctx->EQUIVALENCE()) {
    addVObject((antlr4::ParserRuleContext *)ctx->EQUIVALENCE(), VObjectType::paBinOp_Equivalence);
  } else if (ctx->TAGGED()) {
    addVObject((antlr4::ParserRuleContext *)ctx->TAGGED(), VObjectType::TAGGED);
  }
  if (ctx->QMARK()) {
...
void SV3_1aTreeShapeListener::exitGate_instantiation(SV3_1aParser::Gate_instantiationContext *ctx) {
  if (ctx->PULLUP()) {
    ...
    addVObject((antlr4::ParserRuleContext *)ctx->PULLDOWN(), VObjectType::PULLDOWN);
  }
...
void SV3_1aTreeShapeListener::exitOutput_symbol(SV3_1aParser::Output_symbolContext *ctx) {
  if (ctx->INTEGRAL_NUMBER()) {
    auto number = ctx->INTEGRAL_NUMBER();
    addVObject((antlr4::ParserRuleContext *)ctx->INTEGRAL_NUMBER(), number->getText(), VObjectType::INT_CONST);
  } else if (ctx->SIMPLE_IDENTIFIER()) {
    std::string ident = ctx->SIMPLE_IDENTIFIER()->getText();
    addVObject((antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER(), ident, VObjectType::STRING_CONST);
  }
...
void SV3_1aTreeShapeListener::exitCycle_delay(SV3_1aParser::Cycle_delayContext *ctx) {
  ...
  if (ctx->POUND_POUND_DELAY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->POUND_POUND_DELAY(), ctx->POUND_POUND_DELAY()->getText(),
...
void SV3_1aTreeShapeListener::exitCycle_delay_range(SV3_1aParser::Cycle_delay_rangeContext *ctx) {
  ...
  if (ctx->POUNDPOUND()) {
    addVObject((antlr4::ParserRuleContext *)ctx->POUNDPOUND(), ctx->POUNDPOUND()->getText(),
               VObjectType::POUND_POUND_DELAY);
  }
  if (ctx->PLUS()) {
    addVObject((antlr4::ParserRuleContext *)ctx->PLUS(), VObjectType::paUnary_Plus);
  ...
  if (ctx->ASSOCIATIVE_UNSPECIFIED()) {
    addVObject((antlr4::ParserRuleContext *)ctx->ASSOCIATIVE_UNSPECIFIED(), VObjectType::paAssociative_dimension);
  }
  addVObject(ctx, VObjectType::paCycle_delay_range);
}

void SV3_1aTreeShapeListener::exitSequence_expr(SV3_1aParser::Sequence_exprContext *ctx) {
  if (ctx->WITHIN()) {
    addVObject((antlr4::ParserRuleContext *)ctx->WITHIN(), VObjectType::WITHIN);
  }
  if (ctx->THROUGHOUT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->THROUGHOUT(), VObjectType::THROUGHOUT);
  }
  if (ctx->FIRST_MATCH()) {
    addVObject((antlr4::ParserRuleContext *)ctx->FIRST_MATCH(), VObjectType::FIRST_MATCH);
  }
  if (ctx->INTERSECT()) {
    addVObject((antlr4::ParserRuleContext *)ctx->INTERSECT(), VObjectType::INTERSECT);
  }
  if (ctx->AND()) {
    addVObject((antlr4::ParserRuleContext *)ctx->AND(), VObjectType::AND);
  }
...
void SV3_1aTreeShapeListener::enterUnconnected_drive_directive(SV3_1aParser::Unconnected_drive_directiveContext *ctx) {
  if (ctx->SIMPLE_IDENTIFIER()) {
...
void SV3_1aTreeShapeListener::processPendingTokens(antlr4::tree::ParseTree *tree, size_t endTokenIndex) {
    ...
    switch (lastToken->getType()) {
      case SV3_1aParser::LINE_COMMENT: {
        ...
        if (!trimmed.empty()) {
          ...
          std::tie(object->m_fileId, object->m_startLine, object->m_startColumn, object->m_endLine,
                   object->m_endColumn) = getFileLine(nullptr, lastToken);
          std::tie(object->m_ppStartLine, object->m_ppStartColumn) = ParseUtils::getLineColumn(lastToken);
          std::tie(object->m_ppEndLine, object->m_ppEndColumn) = ParseUtils::getEndLineColumn(lastToken);
      ...
      case SV3_1aParser::BLOCK_COMMENT: {
        addVObject(tree, lastToken->getText(), VObjectType::BLOCK_COMMENT, true);
      } break;
...
void SV3_1aTreeShapeListener::exitBegin_keywords_directive(SV3_1aParser::Begin_keywords_directiveContext *ctx) {}

void SV3_1aTreeShapeListener::exitEnd_keywords_directive(SV3_1aParser::End_keywords_directiveContext *ctx) {}

void SV3_1aTreeShapeListener::exitRandomize_call(SV3_1aParser::Randomize_callContext *ctx) {
  if (ctx->NULL_KEYWORD()) {
    addVObject((antlr4::ParserRuleContext *)ctx->NULL_KEYWORD(), VObjectType::NULL_KEYWORD);
  }
  if (ctx->WITH()) {
...
void SV3_1aTreeShapeListener::exitDeferred_immediate_assert_statement(
  ...
  if (ctx->POUND_DELAY()) {
    addVObject((antlr4::ParserRuleContext *)ctx->POUND_DELAY(), ctx->POUND_DELAY()->getText(),
...
void SV3_1aTreeShapeListener::exitPort_direction(SV3_1aParser::Port_directionContext *ctx) {
  if (ctx->INPUT()) {
...
void SV3_1aTreeShapeListener::exitInteger_atom_type(SV3_1aParser::Integer_atom_typeContext *ctx) {
  if (ctx->INT())
...
void SV3_1aTreeShapeListener::exitTf_port_direction(SV3_1aParser::Tf_port_directionContext *ctx) {
  if (ctx->INPUT())
...
void SV3_1aTreeShapeListener::exitDefault_nettype_directive(SV3_1aParser::Default_nettype_directiveContext *ctx) {
  NetTypeInfo info;
  ...
  if (ctx->SIMPLE_IDENTIFIER()) {
    addVObject((antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER(), ctx->SIMPLE_IDENTIFIER()->getText(),
...
void SV3_1aTreeShapeListener::exitParameter_value_assignment(SV3_1aParser::Parameter_value_assignmentContext *ctx) {
  if (ctx->POUND_DELAY()) {
    addVObject(ctx, ctx->POUND_DELAY()->getText(), VObjectType::INT_CONST);
  }
...
void SV3_1aTreeShapeListener::exitElaboration_system_task(SV3_1aParser::Elaboration_system_taskContext *ctx) {
  if (ctx->number()) {
    addVObject((antlr4::ParserRuleContext *)ctx->number(), ctx->number()->getText(), VObjectType::INT_CONST);
  }
  addVObject((antlr4::ParserRuleContext *)ctx->SIMPLE_IDENTIFIER(), ctx->SIMPLE_IDENTIFIER()->getText(),
             VObjectType::STRING_CONST);
...
void SV3_1aTreeShapeListener::exitSimple_type(SV3_1aParser::Simple_typeContext *ctx) {
  addVObject(ctx, ctx->getText(), VObjectType::paSimple_type);
}

void SV3_1aTreeShapeListener::exitString_type(SV3_1aParser::String_typeContext *ctx) {
  addVObject(ctx, ctx->getText(), VObjectType::paString_type);
}

void SV3_1aTreeShapeListener::exitThis_dot_super(SV3_1aParser::This_dot_superContext *ctx) {
  addVObject(ctx, ctx->getText(), VObjectType::paThis_dot_super);
}

void SV3_1aTreeShapeListener::exitImplicit_class_handle(SV3_1aParser::Implicit_class_handleContext *ctx) {
